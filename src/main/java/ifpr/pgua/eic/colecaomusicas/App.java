...
public class App extends BaseAppNavigator {
    ...
    /* método para registrar as telas da app */
    @Override
    public void registrarTelas() {
        registraTela("PRINCIPAL", new ScreenRegistryFXML(App.class, "principal.fxml", o->new Principal())); /*nome da classe, caminho do arquivo, construtor do objeto */
